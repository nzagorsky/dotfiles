...
hs.hotkey.bind({ "alt", "shift" }, "F", function()
	module.toggle_window_maximized()
end)

for i = 1, 9 do
	hs.hotkey.bind({ "alt", "shift" }, tostring(i), function()
		module.MoveWindowToSpace(i)
	end)
end

hs.hotkey.bind({ "alt", "shift" }, "h", function()
	hs.window.focusedWindow():move(module.units.left50, nil, true)
end)
hs.hotkey.bind({ "alt", "shift" }, "j", function()
	hs.window.focusedWindow():move(module.units.bot50, nil, true)
end)
hs.hotkey.bind({ "alt", "shift" }, "k", function()
	hs.window.focusedWindow():move(module.units.top50, nil, true)
end)
hs.hotkey.bind({ "alt", "shift" }, "l", function()
	hs.window.focusedWindow():move(module.units.right50, nil, true)
end)
